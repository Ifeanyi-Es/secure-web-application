...
function getPatientsFromDB($conn) {
    $patients = [];
    $sql = "SELECT 
...
$patients = getPatientsFromDB($conn);
$conn->close();
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title> Patient Tracker — Internship Matcher — Lancashire Medicare</title>
...
<body>
      ...
      <aside class="col-12 col-md-2 p-4 h-100" id="sidebar">
        <div class="d-flex flex-column h-100">
          <nav class="nav nav-pills flex-column mb-3" aria-label="Main navigation">
            ...
            <a class="nav-link active d-flex align-items-center mb-2" href="employer_patient_tracker.php" aria-current="page">
  ...
  <script src="../js/employee_patient_tracker.js"></script>
